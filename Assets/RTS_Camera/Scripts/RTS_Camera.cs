    ...
    public class RTS_Camera : MonoBehaviour
    {
        ...
        private void Rotation()
        {
            ...
            if (useMouseRotation && Input.GetKey(mouseRotationKey))
            {
                ...
                var orbitDeltaAngle = -MouseAxis.y * Time.deltaTime * mouseRotationSpeed;
                var orbitClampedAngle = Mathf.Clamp(orbitDeltaAngle + m_Transform.eulerAngles.x, 10, 90);
                m_Transform.rotation =  Quaternion.Euler(orbitClampedAngle, m_Transform.eulerAngles.y, m_Transform.eulerAngles.z);          
            }
        }
